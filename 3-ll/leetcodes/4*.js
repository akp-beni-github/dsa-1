...
class LinkedList {
    ...
    partitionList(x){
        ...
        const dummy1 = new Node(0);//nodes
        const dummy2 = new Node(0);
        let prev1 = dummy1;//pointers
        let prev2 = dummy2; 
        //loop to null
        ...
        while(cur!==null){
            ...
            if(cur.value < x){
                ...
                prev2.next = cur;//set place to value 
                prev2 = cur;//set pointer to node
            }
            cur=cur.next;
        }
        // Terminate the second sublist
        prev2.next = null; // prev2  for the right
        // Merge the sublists   
        prev1.next = dummy2.next;  //prev1 for the left  //dummy2.next front without the 0 of dummy2
        // Update the head of the list    
        this.head = dummy1.next; //move head out of 0 of dummy1
