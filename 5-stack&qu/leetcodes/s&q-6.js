...
class MyQueue {
    constructor() {
        this.stack1 = new Stack();//main 
        this.stack2 = new Stack();//temp
    }
    ...
    enqueue(value){//put the value at the bottom
        while(!this.stack1.isEmpty()){//pop stack1 push stack2 until 1 is emtpy
            this.stack2.push(this.stack1.pop());
        }//stack1 is empty 
        //push value to stack 2 or 1 ***
        this.stack2.push(value);
        

        //pushing all back to stack1
